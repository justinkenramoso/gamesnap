...
function GameHighlight(props) {
  ...
  const [HighlightGameBackground, setHighlightGameBackground] = useState("");
  ...
  useEffect(() => {
    axios
      ...
      .then(function (response) {
        ...
        setHighlightGameBackground(response.data.screenshots[0].image);
      })
  ...
  return (
    <section
      id="highlight"
      style={{ backgroundImage: `url(${HighlightGameBackground})` }}
    >
